...
try {
    ...
    console.log('The environment is not installed, and the environment is automatically installed.........');
    execSync('npm install colors');
    console.log('The installation is complete, please re-run the script');
    process.exit();
}
...
try {
    ...
    console.log('Please make sure the directory has ua.txt and proxy.txt.');
    process.exit();
}
